...
//
//   /finca           → just the location line
//   /finca/[slug]    → ← All properties · Punta Paloma · 300 m walk
//
// The back link uses Next prefetching — clicking it returns to /finca
// without a full page reload. `aria-label` carries the verbose form for
// screen readers; the visible arrow + label is intentionally compact.
export function FincaEyebrow() {
  ...
  return (
    <div className="mb-8 flex items-center gap-3 text-xs font-mono uppercase tracking-[0.3em] text-ocean">
      ...
      {onSlugPage && <span className="text-slate-300" aria-hidden>·</span>}
